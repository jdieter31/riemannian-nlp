    ...
    def update(self, **kwargs):
        ...
        for k in list(kwargs):
            ...
            try:
                ...
                if isinstance(expected_type, type) and issubclass(expected_type, ConfigDict) and hasattr(self, k):
        ...
        try:
            ...
            raise ValueError(f"Provided entries did not validate: {e.args[0] if e.args else '(unspecified)'}")
...
try:
    ...
    ConfigDictParser = lark.Lark(CONFIG_DICT_GRAMMAR, parser='lalr', transformer=_ConfigDictTransformer())
except ImportError:
    lark = None
